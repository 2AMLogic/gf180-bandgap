...
def compose_deck(tb: Testbench, pdk: Pdk, point: PvtPoint) -> str:
    ...
    lines: list[str] = [
        f"* {tb.name} @ {point.label} -- GENERATED by sim/harness, do not edit",
...
def run_point(
    ...
    deck_path = workdir / f"{point.label}.spice"
    log_path = workdir / f"{point.label}.log"
...
def run_grid(
    ...
    def _one(index_point):
        ...
        result = run_point(tb, pdk, point, workdir, timeout_s=timeout_s)
